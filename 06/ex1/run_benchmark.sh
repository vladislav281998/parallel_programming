#!/bin/bash
#SBATCH --job-name=code_snippets_benchmark
#SBATCH --output=code_snippets_benchmark_%j.out
#SBATCH --ntasks=1
...
# Function to run benchmarks and log times
run_benchmarks () {
    local program=$1
    local threads=$2
    local iteration=$3
...
# Single-threaded and multithreaded program arrays
single_thread_programs=(task1-unoptimized task1-optimized task2-unoptimized task3-unoptimized)
multithreaded_programs=(task2-optimized task3-optimized)
